...
public class ImagePicker {
    ...
    private boolean selectLimitBl=true;//默认不设置限制
    ...
    public void takePicture(Activity activity, int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(activity.getPackageManager()) != null) {
            if (Utils.existSDCard()){
                takeImageFile = new File(Environment.getExternalStorageDirectory(), "/sldc/Image");
            }
            else{
                takeImageFile = Environment.getDataDirectory();
            }
            takeImageFile = createFile(takeImageFile, "SLDC_IMG_", ".jpg");
    ...
    public boolean isSelectLimitBl() {
        return selectLimitBl;
    }

    public void setSelectLimitBl(boolean selectLimitBl) {
        this.selectLimitBl = selectLimitBl;
    }
    ...
    public void restoreInstanceState(Bundle savedInstanceState) {
        ...
        selectLimitBl = savedInstanceState.getBoolean("selectLimitBl");
    ...
    public void saveInstanceState(Bundle outState) {
        ...
        outState.putBoolean("selectLimitBl", selectLimitBl);
