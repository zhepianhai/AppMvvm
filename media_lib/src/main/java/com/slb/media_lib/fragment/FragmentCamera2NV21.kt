...
import com.gw.safty.common.extensions.showToast
...
class FragmentCamera2NV21 : Fragment() {
    ...
    private fun openCamera(width: Int, height: Int) {
        ...
        try {
            ...
            previewSize=ZPHCameraUtil.chooseOptimalSize(map.getOutputSizes(MediaRecorder::class.java),width,height,videoSize)
