...
public class MyNotificationManagerUtil extends ContextWrapper {
    private Context mContext;
    public static final String CHANNEL_ID = "location";
    private static final String CHANNEL_NAME = "水利督查定位通知";
    private NotificationManager mManager;
    private int[] flags;

    public MyNotificationManagerUtil(Context mContext) {
        super(mContext);
     ...
     * @return
     */
    public MyNotificationManagerUtil setOngoing(boolean ongoing) {
     ...
     * @return
     */
    public MyNotificationManagerUtil setContent(RemoteViews remoteViews) {
     ...
     * @return
     */
    public MyNotificationManagerUtil setContentIntent(PendingIntent intent) {
        this.intent = intent;
        return this;
    }
     ...
     * @return
     */
    public MyNotificationManagerUtil setTicker(String ticker) {
        this.ticker = ticker;
        return this;
    }
     ...
     * @return
     */
    public MyNotificationManagerUtil setPriority(int priority) {
     ...
     * @return
     */
    public MyNotificationManagerUtil setOnlyAlertOnce(boolean onlyAlertOnce) {
     ...
     * @return
     */
    public MyNotificationManagerUtil setWhen(long when) {
        this.when = when;
        return this;
    }
     ...
     * @return
     */
    public MyNotificationManagerUtil setSound(Uri sound) {
        this.sound = sound;
        return this;
    }
     ...
     * @return
     */
    public MyNotificationManagerUtil setDefaults(int defaults) {
     ...
     * @return
     */
    public MyNotificationManagerUtil setVibrate(long[] pattern) {
     ...
     * @return
     */
    public MyNotificationManagerUtil setFlags(int... flags) {
        this.flags = flags;
        return this;
    }
    ...
    public  void isOpen(Context context){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            final NotificationChannel channelOp = manager.getNotificationChannel("location");
            if (channelOp.getImportance() == NotificationManager.IMPORTANCE_NONE) {

                AlertDialog.Builder builer = new AlertDialog.Builder(context);
                builer.setTitle(R.string.dialog_remote_view_title);
                builer.setMessage(R.string.dialog_remote_view_content);
                //
                builer.setPositiveButton(R.string.dialog_confirm, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {

                        Intent intent = new Intent(Settings.ACTION_CHANNEL_NOTIFICATION_SETTINGS);
                        intent.putExtra(Settings.EXTRA_APP_PACKAGE, getPackageName());
                        intent.putExtra(Settings.EXTRA_CHANNEL_ID, channelOp.getId());
                        startActivity(intent);
                        Toast.makeText(mContext, "请手动将通知打开", Toast.LENGTH_SHORT).show();
                    }
                });
                //当点取消按钮时返回
                builer.setNegativeButton(R.string.dialog_cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
